...
class CancelledOrdersView extends StatefulWidget {
  const CancelledOrdersView({super.key});

  @override
  State<CancelledOrdersView> createState() => _CancelledOrdersViewState();
}

class _CancelledOrdersViewState extends State<CancelledOrdersView> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      stream: databaseRef.orderByChild('status').equalTo('Cancelled').onValue,
      builder: (
          context,
          snap,
          ) {
...
// reverse: true,
              ...
              itemBuilder: (context, index) {
                return filteredItems[index]['status'] == 'Cancelled'
                    ? Padding(
                  padding:
                      ...
                      onTap: () {
                        Get.to(
                            DetailScreen(
                              ...
                              ['status'],
                              package: filteredItems[index]
                              ['package'],
                              pickDate: filteredItems[index]
                              ['pickDate'],
                              pickTime: filteredItems[index]
                              ['pickTime'],
                              dropDate: filteredItems[index]
                              ['dropDate'],
                              dropTime: filteredItems[index]
                              ['dropTime'],
